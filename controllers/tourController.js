...
// const newTour = new Tour.create({})
// newTour.save   //Previous way of creating a new tour
//Tour.create() will return a promise. req.body is the data that is being created **
...
exports.getTourStats = catchAsync(async (req, res, next) => {
  const stats = await Tour.aggregate([
    ...
    // {
    // $match: { _id: { $ne: 'EASY' } }, // We can match more than once
    // },
  ]);
